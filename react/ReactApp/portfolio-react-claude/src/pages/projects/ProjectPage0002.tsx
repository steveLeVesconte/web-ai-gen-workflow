...
import { getNextProject,getPreviousProject} from '../../services/ProjectDataService'; // Import the ProjectDataService module
...
/*   const project: Project = {
  ...
  return (
    <div className="project-page">
      <h1>A real-time chat application with AI-powered features 2</h1>
      <p className="project-date">Completed on: {new Date('2023-12-15').toLocaleDateString()}</p>
      
      <img src="https://picsum.photos/1200/600?random=1" alt="A real-time chat application with AI-powered features" className="article-image" />
